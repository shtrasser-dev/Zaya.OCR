...
/// </summary>
internal sealed class ParagraphAssembler : IParagraphAssembler
{
    ...
    /// </summary>
    private static void AssignParagraphIds(List<TextParagraph> paragraphs, ITextLayoutHistoryService history)
    {
