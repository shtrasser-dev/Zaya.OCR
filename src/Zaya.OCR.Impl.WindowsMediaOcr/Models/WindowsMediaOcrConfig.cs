...
/// <summary>
/// Typed configuration for <see cref="WindowsMediaOcrService"/>.
...
public sealed class WindowsMediaOcrConfig
{
    ...
    /// <see cref="WindowsMediaOcrService.CreateSessionAsync(IReadOnlyDictionary{string, object}, CancellationToken)"/>.
    /// </summary>
